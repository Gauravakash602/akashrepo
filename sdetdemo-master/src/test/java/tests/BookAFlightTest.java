...
public class BookAFlightTest extends BaseTest {
    ...
    public Object[][] bookFlightsData(){
        ...
        for(int i = 0; i< bookFlights.size(); i++){
            for(String[] bookFlight : bookFlights){
                rawData[i++][0] = new BookingDetailsCreator(bookFlight);
            }
        }
        return rawData;
    }
    ...
    public void searchForFlights(BookingDetailsCreator data){
    ...
    public void chooseLowestPricedAirline(BookingDetailsCreator data){
    ...
    public void purchaseFlightTicket(BookingDetailsCreator data){
